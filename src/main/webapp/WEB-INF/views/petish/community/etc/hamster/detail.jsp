...
<%
	HamsterPostResponseDTO dto = (HamsterPostResponseDTO) request.getAttribute("dto");
...
<link rel="stylesheet" href="/resources/css/etc/detail.css">
...
<body style="font-family: 'Do Hyeon', sans-serif;">
			...
			<div class="col-md-13">
				...
				<button type="submit"
					...
					<i class="fa fa-align-justify"></i> <a
						href="<c:url value='/etc/hamster/'/>"> 목록 </a>
				</button>
							...
							<nav aria-label="Page navigation example"
								...
								<button type="submit"
									...
									<i class="fa fa-trash-o"></i> <a
										href="/etc/hamster/delete/<%=dto.getId()%>">삭제 </a>
								</button>
							</nav>
							<%
								}
	...
	<script type="text/javascript" src="/resources/js/etc/comment.js"></script>
	<script src="/resources/js/report.js"></script>
	<script src="/resources/js/etc/detail.js"></script>
